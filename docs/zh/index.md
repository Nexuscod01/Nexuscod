...
<section class="home-page-section home-page-use-case-section"><div class="home-page-section-head home-page-section-head-centered"><p class="home-page-eyebrow">为真实时刻而生</p><h2 class="home-page-section-title">看 AI Agent 在手机上交付完整应用。</h2><p class="home-page-section-copy">在一个可审查的移动工作区中，观察规划、实现、验证、修复与 Git 交付如何连续完成。</p></div><div class="home-page-use-case-grid"><a href="/zh/use-cases/" class="home-page-use-case-card"><span>AI AGENT 构建演示</span><h3>从一条产品需求到通过测试的任务看板。</h3><p>在 NimoteCode 中观看完整的构建、测试与提交流程。</p></a></div></section>
