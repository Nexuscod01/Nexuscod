---
title: 移动代码编辑器 | NimoteCode
description: 使用 NimoteCode 移动代码编辑器的标签页、剪贴板、撤销/重做、光标定位、大纲导航，以及与 Terminal 和 AI 面板联动的工作流。
---
...
- 用多个标签页跟进一次小范围改动。
- 使用复制、剪切、粘贴、全选、撤销和重做。
- 在排查错误或处理 review 时查看当前行列位置。
- 符号数据可用时，通过大纲了解代码结构。
- 让 [AI 助手](/zh/docs/ai) 结合当前激活文件理解问题。
