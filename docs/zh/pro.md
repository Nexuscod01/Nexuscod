...
description: NimoteCode Pro 解锁 Git 写入、多终端、AI Agent 与远程搜索、LSP、调试和 Sync/Cache。
---

# NimoteCode Pro

NimoteCode 免费版可打开项目、编辑文件、使用基础终端与 AI Chat。**Pro** 面向需要完成完整移动开发闭环的任务：受限 Git 写入、AI 辅助、更深入的诊断，以及多个终端上下文。
...
免费版仍可充分体验核心工作区：本地或 SSH 项目、编辑、终端、AI Chat 和基础 Tasks。新用户可获得按设备计算的 3 天 Pro 试用，用于体验 Agent、远程搜索及其他受限工作流。
